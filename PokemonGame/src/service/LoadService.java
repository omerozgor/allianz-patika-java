...
public class LoadService {
    ...
    public ArrayList<Pokemon> loadPokemons(){
        ...
        Pokemon pokemon1 = new Pikachu("Pikachu", 100, 10, TypeEnum.ELECTRICY, electricty,WeatherTypeEnum.WINDY);
        Pokemon pokemon2 = new Sqiurtle("Squirtle", 100, 8, TypeEnum.WATER, water,WeatherTypeEnum.SUNNNY);
        Pokemon pokemon3 = new Charmander("Charmender", 100, 12, TypeEnum.FIRE, fire,WeatherTypeEnum.CLOUDY);
        Pokemon pokemon4 = new Balbausar("Balbausar", 100, 7, TypeEnum.EARTH, earth,WeatherTypeEnum.RAINY);
